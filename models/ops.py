...
class PoolBN(nn.Module):
    ...
    def __init__(self, pool_type, C, kernel_size, stride, padding, affine=True):
        ...
        self.bn = BatchNorm2d(C, affine=affine)
...
class FactorizedReduce(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.bn(out)
        # print ("conv1 param: {}".format(self.conv1.weight))
        # print ("bn mean: {}".format(self.bn.running_mean))
        # print ("bn var: {}".format(self.bn.running_var))
        return out
